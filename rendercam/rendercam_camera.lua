...
function Camera:screen_to_world_2d(x, y, delta, worldz)
	...
	local x1 = (x - self.screen_size.w * 0.5) / self.screen_size.w * 2
	local y1 = (y - self.screen_size.h * 0.5) / self.screen_size.h * 2
	...
	local t = ( worldz - self.abs_near_z) / (self.far_z - self.near_z) -- normalize desired Z to 0-1 from abs_nearZ to abs_farZ
